...
--
-- Base de données : `2023_atsurvey_v1_null`
--

-- --------------------------------------------------------

--
-- Structure de la table `at_answers`
--
...
--
-- Structure de la table `at_configs`
--

CREATE TABLE `at_configs` (
...
--
-- Déchargement des données de la table `at_configs`
--

INSERT INTO `at_configs` (`id`, `variable`, `value`) VALUES
(1, 'site_title', 'at Premium Survey'),
(2, 'site_url', 'atbounatiro.com'),
(3, 'site_description', 'Creating surveys and polls should be simple and fast.\r\nYou have things to get done. You need info to do them well. at Premium Survey is the way to a survey or poll in minutes. A simple tool, but surprisingly powerful.'),
(4, 'site_keywords', 'survey, vote, poll, voting, at, surveys, at survey, codecanyon, php script'),
(5, 'site_author', 'at bounatiro'),
(6, 'site_register', '1'),
(7, 'site_plans', '0'),
(8, 'site_forget', '1'),
(10, 'site_noreply', 'donotreply@atbounatiro.com'),
(12, 'login_facebook', '1'),
(13, 'login_twitter', '1'),
(14, 'login_google', '1'),
(15, 'login_fbAppId', ''),
...
(33, 'site_country', 'US'),
(34, 'site_landing', '1'),
(35, 'site_facebook', 'prof.atbounatiro'),
(36, 'site_instagram', 'bounatiroat'),
(37, 'site_twitter', ''),
(38, 'site_youtube', ''),
(39, 'site_skype', ''),
(40, 'site_logo', 'assets/img/logo3.png'),
...
(50, 'feature_link4', '1'),
(51, 'iframe_link', '1'),
(52, 'site_email', 'support@company.com'),
(53, 'site_phone', '(+1) 987 654 3210'),
(54, 'support_link', NULL),
(55, 'privacy_link', NULL),
(56, 'terms_link', NULL),
(57, 'site_onlymembers', '0'),
(58, 'site_onlyadmins', '0'),
(59, 'site_sendsurveyemail', ''),
(60, 'site_phonemask', '000-000-0000'),
(61, 'site_colors', NULL),
...
--
-- Structure de la table `at_languages`
--
...
--
-- Déchargement des données de la table `at_languages`
--

INSERT INTO `at_languages` (`id`, `language`, `short`, `isdefault`, `created_at`, `updated_at`, `content`) VALUES
...
--
-- Structure de la table `at_logics`
--

CREATE TABLE `at_logics` (
  `id` int(11) NOT NULL,
...
--
-- Structure de la table `at_pages`
--
...
--
-- Déchargement des données de la table `at_pages`
--

INSERT INTO `at_pages` (`id`, `title`, `content`, `created_at`, `updated_at`, `footer`, `header`, `sort`, `keywords`, `description`) VALUES
...
--
-- Structure de la table `at_payments`
--
...
--
-- Structure de la table `at_plans`
--
...
--
-- Déchargement des données de la table `at_plans`
--

INSERT INTO `at_plans` (`id`, `plan`, `price`, `currency`, `desc1`, `desc2`, `desc3`, `desc4`, `desc5`, `desc6`, `desc7`, `desc8`, `desc9`, `created_at`, `surveys_month`, `surveys_steps`, `surveys_questions`, `surveys_answers`, `surveys_iframe`, `surveys_rapport`, `surveys_export`, `survey_design`, `show_ads`, `support`) VALUES
...
--
-- Structure de la table `at_questions`
--
...
--
-- Structure de la table `at_responses`
--

CREATE TABLE `at_responses` (
  `id` int(11) NOT NULL,
...
--
-- Structure de la table `at_steps`
--

CREATE TABLE `at_steps` (
  `id` int(11) NOT NULL,
  `date` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `author` mediumint(8) UNSIGNED NOT NULL DEFAULT '0',
  `survey` int(11) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Structure de la table `at_survies`
--

CREATE TABLE `at_survies` (
  `id` int(11) NOT NULL,
  `title` varchar(255) DEFAULT NULL,
  `date` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `author` mediumint(8) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Structure de la table `at_users`
--
...
--
-- Déchargement des données de la table `at_users`
--

INSERT INTO `at_users` (`id`, `firstname`, `lastname`, `username`, `password`, `photo`, `date`, `level`, `email`, `gender`, `address`, `birth`, `moderat`, `verified`, `credits`, `description`, `language`, `updated_at`, `trash`, `plan`, `lastpayment`, `txn_id`, `country`, `state`, `city`, `social_id`, `social_name`) VALUES
(1, NULL, NULL, 'bounatiro', '94ca247fff5ad413788a1c8d8c80394a246dba1c', NULL, 1694381381, 6, 'el.bouirtou@gmail.com', 0, NULL, NULL, NULL, 0, NULL, NULL, 0, 0, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
--
-- Index pour la table `at_answers`
--
ALTER TABLE `at_answers`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `at_configs`
--
ALTER TABLE `at_configs`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `at_languages`
--
ALTER TABLE `at_languages`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `at_logics`
--
ALTER TABLE `at_logics`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `at_pages`
--
ALTER TABLE `at_pages`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `at_payments`
--
ALTER TABLE `at_payments`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `at_plans`
--
ALTER TABLE `at_plans`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `at_questions`
--
ALTER TABLE `at_questions`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `at_responses`
--
ALTER TABLE `at_responses`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `at_steps`
--
ALTER TABLE `at_steps`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `at_survies`
--
ALTER TABLE `at_survies`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `at_users`
--
...
--
-- AUTO_INCREMENT pour la table `at_answers`
--
ALTER TABLE `at_answers`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `at_configs`
--
ALTER TABLE `at_configs`
  MODIFY `id` tinyint(3) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=63;

--
-- AUTO_INCREMENT pour la table `at_languages`
--
ALTER TABLE `at_languages`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT pour la table `at_logics`
--
ALTER TABLE `at_logics`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `at_pages`
--
ALTER TABLE `at_pages`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT pour la table `at_payments`
--
ALTER TABLE `at_payments`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `at_plans`
--
ALTER TABLE `at_plans`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT pour la table `at_questions`
--
ALTER TABLE `at_questions`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `at_responses`
--
ALTER TABLE `at_responses`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `at_steps`
--
ALTER TABLE `at_steps`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `at_survies`
--
ALTER TABLE `at_survies`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `at_users`
--
ALTER TABLE `at_users`
