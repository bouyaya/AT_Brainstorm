...
?>
	...
	<div class="pt-wrapper">
		...
		<div class="pt-admin-body">
			...
			<?php
			if (!$pg) {
				include __DIR__ . "/files/cpanel/main.php";
			} elseif ($pg == "plans") {
				include __DIR__ . "/files/cpanel/plans.php";
			} elseif ($pg == "surveys") {
				include __DIR__ . "/files/cpanel/surveys.php";
			} elseif ($pg == "users") {
				include __DIR__ . "/files/cpanel/users.php";
			} elseif ($pg == "payments") {
				include __DIR__ . "/files/cpanel/payments.php";
			} elseif ($pg == "pages") {
				include __DIR__ . "/files/cpanel/pages.php";
			} elseif ($pg == "setting") {
				include __DIR__ . "/files/cpanel/setting.php";
			} elseif ($pg == "languages") {
				include __DIR__ . "/files/cpanel/languages.php";
			}
			?>
