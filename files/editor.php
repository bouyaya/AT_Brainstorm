...
?>
	<style>
		...
		.pt-surveybg a[href="#finish"] {
			...
			<?php endif; ?><?php if (!$survey_colors['bg_gradient'] && $survey_colors['bg1_color1']) : ?>background: linear-gradient(to right, <?= $survey_colors['bg1_color1'] ?> 0%, <?= $survey_colors['bg1_color2'] ?> 80%, <?= $survey_colors['bg1_color2'] ?> 100%);
			<?php endif; ?><?php if (isset($survey_colors['bg_gradient']) && isset($survey_colors['bg1_color1'])) : ?>background: <?= $survey_colors['bg1_color1'] ?>;
		...
		.pt-surveybg a[href="#next"] {
			...
			<?php endif; ?><?php if (!$survey_colors['bg_gradient'] && $survey_colors['bg2_color1']) : ?>background: linear-gradient(to right, <?= $survey_colors['bg2_color1'] ?> 0%, <?= $survey_colors['bg2_color2'] ?> 80%, <?= $survey_colors['bg2_color2'] ?> 100%);
			<?php endif; ?><?php if (isset($survey_colors['bg_gradient']) && isset($survey_colors['bg2_color1'])) : ?>background: <?= $survey_colors['bg2_color1'] ?>;
		...
		<?php if (isset($survey_colors['survey_bg'])) : ?>.pt-surveybg {
			background: <?= $survey_colors['survey_bg'] ?>
		}

		<?php endif; ?><?php if (isset($survey_colors['survey_bg'])) : ?>.choice[type=checkbox]:checked+label:before {
		...
		<?php endif; ?><?php if (isset($survey_colors['input_bg'])) : ?>.pt-surveybg input[type=text] {
